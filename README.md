...
以下のサイトを参考に Blitz で memo アプリを作成してみる
...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitzMemo
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/blitzMemo_test
```
